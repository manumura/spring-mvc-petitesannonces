...
CREATE TABLE USER_ACCOUNT (
   ...
   USER_IS_EMAIL_CONFIRMED BOOLEAN DEFAULT FALSE,
...
VALUES ('manu', '$2a$10$27VaG6hjRrj2PMvwpSErbumO39uDHUGl.6Q98STrzKYzUbbpE1EMW', 'Manu', 'Manu', '1981-08-14', 'manu@xyz.com', true, 0);
...
(
   ...
   CATEGORY_IS_DELETED BOOLEAN DEFAULT FALSE,
...
(
   ...
   ITEM_DATE_CREATION TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
   ITEM_DATE_LAST_UPDATE TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, -- ON UPDATE CURRENT_TIMESTAMP
   ITEM_IS_DELETED BOOLEAN DEFAULT FALSE,
   PRIMARY KEY (ITEM_ID),
